...
const Career = ( props ) => {
    ...
    const allJobs = jobData.map((job) => (
        <tr className="">
            <td>
                <span>position title</span> {job.jobTitle}
            </td>
            <td>
                <span>location</span> {job.jobCity}, {job.jobCountry}

            </td>
            <td>
                <span>date posted</span> {job.createdAt}
            </td>
            <td className="view-more-btn">
                <NavLink to={'/job/' + job.id}>view more</NavLink>
            </td>
        </tr>
    ))
                    ...
                    <div className="row">
                        <div className="col-12 text-center">
                            <div className="header-content">
                                <h1>Career</h1>
                                <p>Want to work with a fast-growing international company? SGN is the place for you! Apply
                                    today for an interview with us.
                                </p>
                        ...
                        <div className="col-md-10 mb-4">
                            <form onSubmit={filterData} action="">
                                <div className="form-row">
                                    ...
                                    <div className="col-lg-2 col-md-6 mb-4">
                                        <button type="submit" className="btn btn-lg btn-primary mt-2">Find Jobs</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div className="col-md-12">
                            <div className="table-responsive">
                                <table className="job-table table table-borderless" cellSpacing="0">
                                    <tbody>
                                    {loaded ? jobData.length > 0 ? allJobs : (<h3 className={'text-center'}>No Jobs Found</h3>) : <div className={'text-center'}><Spinner /></div>}
                                    </tbody>
                                </table>
                            </div>
                        </div>
